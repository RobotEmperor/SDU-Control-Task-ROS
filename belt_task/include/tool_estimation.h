...
#ifndef SDU_CONTROL_TASK_ROS_BELT_TASK_INCLUDE_TOOL_ESTIMATION_H_
#define SDU_CONTROL_TASK_ROS_BELT_TASK_INCLUDE_TOOL_ESTIMATION_H_
...
#endif /* SDU_CONTROL_TASK_ROS_BELT_TASK_INCLUDE_TOOL_ESTIMATION_H_ */
